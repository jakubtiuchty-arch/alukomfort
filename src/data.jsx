...
const LINEA = {
  ...
  specs: [
    ...
    { label: 'Grubość szkła bezpiecznego',              value: '44,2 – 55,2 mm' },
  ...
  roofs: [
    ...
    },
    {
      ...
      options: [
        { name: 'VSG/ESG',  sub: 'Kombinacja warstw',  hex: '#d3dfe3', desc: 'Laminat z wcześniej hartowanych tafli. Oznaczenia: 44.2 = 2×4 mm + 2 folie, 55.2 = 2×5 mm + 2 folie.' },
      ],
    },
  ],
  construction: [
  ...
  coverings: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'ESG/VSG — kombinacja', sub: 'Laminat z wcześniej hartowanych tafli. Oznaczenia: 44.2 = 2×4 mm + 2 folie, 55.2 = 2×5 mm + 2 folie.' },
      ],
...
const HORIZON = {
  ...
  variants: [
    {
      ...
      description: 'Bioklimatyczna pergola z dachem ze stabilnych, ruchomych profili aluminiowych. Swobodna regulacja ilości światła i cyrkulacji powietrza. Precyzyjne mechanizmy obrotu lameli zapewniają bezpieczne, całoroczne użytkowanie. Odporna na obciążenia śniegiem i wiatrem zgodnie z normami EN 1991-1-3 i EN 1991-1-4. Sterowanie elektryczne silnikami SOMFY — pilotem lub aplikacją.',
      specs: [
        ...
        { label: 'Sterowanie',                      value: 'SOMFY (pilot / aplikacja)' },
    ...
    },
    {
      ...
      description: 'Zadaszenie z dachem z wysokiej klasy szkła bezpiecznego ESG + VSG laminowanego 44.2 lub 55.2 (grubość 44.2–55.2 mm). Maksymalna szerokość tafli 750 mm. Realizowane pod indywidualny wymiar — nieprzesłonięte niebo przy pełnej ochronie przed deszczem.',
      specs: [
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Wysokość wieńca dachu',           value: '280 mm (profil 280 × 60, 3-komorowy)' },
        { label: 'Maksymalna wysokość zadaszenia',  value: '2 800 mm' },
        { label: 'Sterowanie lameli',               value: 'SOMFY (pilot / aplikacja)' },
        { label: 'Grubość szkła segmentu',          value: '44.2 – 55.2 mm' },
  ...
  constructionNote: 'Konstrukcja przyścienna lub wolnostojąca o maksymalnej wysokości 280 cm. Sterowanie lameli silnikami SOMFY (pilotem lub aplikacją), z opcjonalną automatyką pogodową. Zgodność z normami obciążeń EN 1991-1-3 (śnieg) i EN 1991-1-4 (wiatr).',
  care: [
